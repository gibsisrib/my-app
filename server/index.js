...
- For mixed prepared foods that are normally logged as one item (pizza, burritos, burgers, casseroles, pasta dishes), keep the whole prepared food as one item unless major sides are separate. Prefer common USDA-searchable labels such as "pizza", "burger", "burrito", or "pasta"; put topping details like "pineapple and ham" or "with onions" in "portion" instead of making the food label overly specific.
